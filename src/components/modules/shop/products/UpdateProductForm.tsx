...
const UpdateProductForm = ({ product }: { product: IProduct }) => {
  ...
  const { append: appendFeature, fields: featuresFields } = useFieldArray({
    control: form.control,
    name: "keyFeatures",
  });
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      setCategrise(categoriesData?.data);
  ...
  return (
    <div className="border-2 border-gray-300 rounded-xl flex-grow max-w-3xl mx-auto p-5 ">
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)}>
          ...
          <div>
            ...
            <div className="my-5">
              {featuresFields.map((featureField, index) => (
