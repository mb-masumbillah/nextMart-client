...
export default function CartProductCard({ product }: { product: CartProduct }) {
  ...
  const handleIncrement = (id: string) => {
    dispathch(incrementOrderQuantity(id));
  };

  const handleDecrement = (id: string) => {
    dispathch(decrementOrderQuantity(id));
  };

  const handleRemove = (id:string) =>{
    dispathch(orderRemove(id))
  }
      ...
      <div className="flex flex-col justify-between flex-grow">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button onClick={() => handleRemove(product._id)} variant="outline" className="size-8 rounded-sm">
